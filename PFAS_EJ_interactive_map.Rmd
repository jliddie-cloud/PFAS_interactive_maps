---
title: 'PFAS and environmental justice: interactive maps (beta version)'
...
show.limits <- st_bbox(CWS.counties)
...
popup.f <- function(dataset) {
  ...
  paste("<B>Demographics</B>", "<br/>",
        ...
        "PFOA: ", 
        round(dataset$PFOA.avg, 2)*100, "%", "<br/>",
        "PFOS: ", 
        round(dataset$PFOS.avg, 2)*100, "%", "<br/>",
        "PFNA: ", 
        round(dataset$PFNA.avg, 2)*100, "%", "<br/>",
        "PFHxS: ", 
        round(dataset$PFHxS.avg, 2)*100, "%", "<br/>",
        "PFBS: ", 
        round(dataset$PFBS, 2)*100, "%", "<br/>",
        "At least 1 PFAS: ", 
        round(dataset$Any.avg, 2)*100, "%", "<br/>",
...
percHisp_map1 <- leaflet(CWS.counties) %>%
  ...
  fitBounds(lng1 = as.numeric(show.limits[1]),
            lat1 = as.numeric(show.limits[2]),
            lng2 = as.numeric(show.limits[3]),
            lat2 = as.numeric(show.limits[4]),
          ) %>%
