...
The interactive map below shows data from (THE PFAS+EJ PAPER). These data were collated from sampling campaigns from community water systems in 11 states over 2016-2021. Percent Black and White refer to non-Hispanic Black and White residents, respectively. To analyze within-state trends, polygon layers using "centered" variables (substracting the state-specific mean) are also provided. Additional information on these data are avaialable in (THE PAPER). To change layers, click on the panel in the bottom right. Detectable levels for the statewide sampling data refer to measurement of that PFAS at least once over 5 ng/L.
...
map1 <- leaflet(CWS.counties) %>%
  ...
  addLayersControl(
    ...
    baseGroups  = c("% Hispanic residents", "% Hispanic residents (centered)",
                    ...
                    "% residents living under federal poverty line", "% residents living under federal poverty line (centered)",
